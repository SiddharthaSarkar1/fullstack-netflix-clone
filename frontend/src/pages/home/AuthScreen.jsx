          ...
          <div className="flex-1">
            <div className="relative">
              <img
                ...
                className="mt-4"
              />
              <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rouded-md p-2 ">
                <img
                ...
                <div className="flex justify-between items-center w-full">
                  <div className="flex flex-col gap-0">
                    ...
                    <span className="text-small text-blue-500">
                      Downloading...
                    </span>
                  </div>
